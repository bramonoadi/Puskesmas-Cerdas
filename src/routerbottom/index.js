      ...
      <Tab.Screen
        ...
        options={({navigation}) => {
          ...
          if (exploreState) {
            ...
            if (exploreActiveRoute.name === 'BookingDetail') {
              tabBarVisible = false;
            }
            if (exploreActiveRoute.name === 'BookingForm') {
              tabBarVisible = false;
            }
            if (exploreActiveRoute.name === 'BookingSuccess') {
              tabBarVisible = false;
            }
            if (exploreActiveRoute.name === 'InfoCovid') {
              tabBarVisible = false;
            }
            if (exploreActiveRoute.name === 'Login') {
              tabBarVisible = false;
            }
            if (exploreActiveRoute.name === 'Splash') {
              tabBarVisible = false; 
            }
          }
          //   tabBarButton: (props) => (
